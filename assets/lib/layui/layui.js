...
!(function (i, r) {
  ...
  (s.formatArr = function (e) {
    ...
    (g.prototype.checkDate = function (e) {
      ...
      return (
        c(n) > c(y.max)
          ...
          : c(n) < c(y.min) && (n = y.dateTime = lay.extend({}, y.min)),
        y.range &&
          (c(s.endDate) < c(y.min) || c(s.endDate) > c(y.max)) &&
    ...
    (u.close = function (e) {
      lay("#" + (e ? "layui-laydate" + e : g.thisElemDate)).remove();
    }),
    n
      ? (u.ready(),
        ...
        v = function (e, i) {
          (e =
            ...
            (e = 100 < Math.ceil(e) * m ? Math.ceil(e) * m : Math.round(e) * m)
              ? 100
              : e),
            d.eq(i).css("vertical" === r.type ? "bottom" : "left", e + "%");
          var t,
            a = p(d[0].offsetLeft),
            ...
            l =
              ("vertical" === r.type
                ? (o
                  ...
                  (n = r.range ? p(u() - d[1].offsetTop - d.height()) : 0))
                : o.find("." + x).css("left", e + "%"),
              (a = 100 < a ? 100 : a),
              (n = 100 < n ? 100 : n),
              Math.min(a, n)),
            ...
            n =
              ("vertical" === r.type
                ? o.find("." + y).css({ height: a + "%", bottom: l + "%" })
                : o.find("." + y).css({ width: a + "%", left: l + "%" }),
          ...
          (c = n),
            s
              ...
              .val(c),
            d.eq(i).data("value", n),
            o.find("." + x).html(r.setTips ? r.setTips(n) : n),
            r.range &&
              (t = [d.eq(0).data("value"), d.eq(1).data("value")])[0] > t[1] &&
              t.reverse(),
            r.change && r.change(r.range ? t : n);
        },
        p = function (e) {
          var i = ((e / u()) * 100) / m,
            t = Math.round(i) * m;
      ...
      o.find("." + b).each(function (l) {
        ...
        o.on("click", function (e) {
          ...
          !t.is(event.target) &&
            ...
            ((i =
              (((t =
                (t =
                  (t =
                    "vertical" === r.type
                      ? u() - e.clientY + h(this).offset().top
                      : e.clientX - h(this).offset().left) < 0
                    ? 0
                    : t) > u()
                  ? u()
                  : t) /
            ...
            (t = r.range
              ? "vertical" === r.type
                ? Math.abs(t - parseInt(h(d[0]).css("bottom"))) >
                  Math.abs(t - parseInt(h(d[1]).css("bottom")))
                  ? 1
                  : 0
                : Math.abs(t - d[0].offsetLeft) > Math.abs(t - d[1].offsetLeft)
                ? 1
                : 0
              : 0),
            v(i, t),
          ...
          e =
            ((e =
              (e = (e = isNaN(e) ? 0 : e) < r.min ? r.min : e) > r.max
                ? r.max
                : e),
            ((((this.value = e) - r.min) / (r.max - r.min)) * 100) / m);
        v(e, 0);
      };
      s.children("." + T)
        .children("input")
...
layui.define(["jquery", "lay"], function (e) {
  ...
  (c.prototype.config = {
    ...
    (c.prototype.renderPicker = function () {
      ...
      y(l)[0] && y(l).data("index") == e.index
        ? e.removePicker(c.thisElemInd)
        : (e.removePicker(c.thisElemInd), y("body").append(i)),
    ...
    (c.prototype.position = function () {
      var e = this,
        i = e.config;
      return (
        o.position(e.bindElem || e.elemColorBox[0], e.elemPicker[0], {
          position: i.position,
          align: "center",
        }),
        e
    ...
    (c.prototype.events = function () {
      ...
      i.elemColorBox.on("click", function () {
        ...
        e.elem[0] &&
          ...
          (t.on(r, function (e) {
            y(e.target).hasClass(n) ||
              y(e.target).parents("." + n)[0] ||
              y(e.target).hasClass(l.replace(/\./g, "")) ||
              y(e.target).parents(l)[0] ||
              (i.elemPicker &&
                (i.color
      ...
      tabDelete: function (t, i) {
        ...
        i.hasClass(r) &&
          (i.next()[0]
            ...
            : i.prev()[0] && C.tabClick.call(i.prev()[0], null, a - 1)),
          i.remove(),
          l.eq(a).remove(),
          setTimeout(function () {
            C.tabAuto();
          ...
          n = {
            ...
            select: function (e) {
              ...
              e.each(function (e, t) {
                ...
                var o,
                  s = "string" == typeof i.attr("lay-search"),
                ...
                layui.each(t, function (e, t) {
                  ...
                  if (a) {
                    var n =
                      ...
                      i = i || a[1];
                    if (
                      ("required" === t && (i = o.attr("lay-reqText") || i), n)
                    )
                      return (
                        "tips" === s
                          ? h.tips(
                              i,
                              "string" != typeof o.attr("lay-ignore") && l
                                ? o.next()
                                : o,
                              { tips: 1 }
                            )
...
layui.define(["laytpl", "laypage", "form", "util"], function (e) {
  ...
  var m = layui.$,
        ...
        t &&
          (i =
            "function" == typeof t
              ...
              : v(m(t).html() || String(i)).render(e.tplData)),
    ...
    i = function (e) {
      (this.index = ++b.index),
        (this.config = m.extend({}, this.config, b.config, e)),
        this.render();
    },
    F =
      ((i.prototype.config = {
      ...
      (i.prototype.render = function (e) {
        ...
        a.height &&
          ...
          (a.height = _.height() - t.fullHeightGap)),
          t.setInit();
        var i,
          l,
          e = a.elem,
        ...
        o
          ...
          .html(v(R).render({ data: a, index: t.index })),
          (a.index = t.index),
          (t.key = a.id || a.index),
          n[0] && n.remove(),
          e.after(o),
      ...
      (i.prototype.initOpts = function (e) {
        ...
        e.checkbox && (e.type = "checkbox"),
          ...
          "normal" !== e.type &&
            ...
            (e.width =
              e.width ||
              { checkbox: 50, radio: 50, space: 15, numbers: 60 }[e.type]));
      }),
                    ...
                    l.colGroup ||
                      ((t = [
                        '<td data-field="' +
                          ...
                          l.templet && e.push('data-content="' + n + '"'),
                        ...
                        '<div class="layui-table-cell laytable-cell-' +
                          ...
                          (function () {
                            var e,
                              t = m.extend(!0, { LAY_INDEX: c, LAY_COL: l }, d),
                              a = b.config.checkName,
                              i = b.config.disabledName;
                            switch (l.type) {
                              case "checkbox":
                                return (
      ...
      (i.prototype.renderTotal = function (e, o) {
        ...
        c.totalRow &&
          ...
          r.layTotal.find("tbody").html("<tr>" + d.join("") + "</tr>"));
      }),
      ...
      (i.prototype.sort = function (l, e, t, a) {
        ...
        try {
          ...
          if (n.sortKey && !t && s === n.sortKey.field && e === n.sortKey.sort)
            return;
          var y = n.layHeader.find("th .laytable-cell-" + u).find(L);
          n.layHeader.find("th").find(L).removeAttr("lay-sort"),
        ...
        (n.sortKey = { field: s, sort: e }),
          d.autoSort &&
            ("asc" === e
              ...
              : "desc" === e
              ? (i = layui.sort(c, s, !0))
              : ((i = layui.sort(c, b.config.indexName)),
                delete n.sortKey,
                delete d.initSort)),
          (o[d.response.dataName] = i || c),
          n.renderData({ res: o, curr: n.page, count: n.count, sort: !0 }),
          a &&
            ((d.initSort = { field: s, type: e }),
      ...
      (i.prototype.events = function () {
          ...
          n =
                    ...
                    : l({
                        list: [
                          ...
                          t.on("click", function () {
                            ...
                            b.exportFile.call(s, r.id, null, e);
                          });
                        },
                      });
                  break;
            ...
            x.docEvent ||
              S.on("mousemove", function (e) {
                var t;
                x.eventMoveElem &&
                  ((t = x.eventMoveElem.data(j) || {}),
                  x.eventMoveElem.data("resizing", 1),
                  e.preventDefault(),
                  t.rule &&
                ...
                x.eventMoveElem &&
                  ...
                  i.css("cursor", ""),
                  s.scrollPatch(),
                  x.eventMoveElem.removeData(j),
                  delete x.eventMoveElem);
              }),
            (x.docEvent = !0),
            e
              .on("click", function (e) {
            ...
            (s.commonMember = function (e) {
              ...
              return m.extend(
                {
                  tr: r,
                  data: b.clearCacheKey(c),
                  del: function () {
                    (b.cache[s.key][t] = []), r.remove(), s.scrollPatch();
                  },
                  update: function (e, d) {
                    (e = e || {}),
            ...
            s.layBody
              ...
              .on("mouseleave", "tr", function () {
                var e = m(this),
                  t = e.index();
                e.data("off") ||
                  s.layBody.find("tr:eq(" + t + ")").removeClass(E);
              })
              ...
              .on("blur", "." + D, function () {
                ...
                s.eachCols(function (e, t) {
                  ...
                  t
                    ...
                    .html(
                      ((e = this.value),
                      k.call(s, { item3: a || {}, content: e, tplData: l }))
                    ),
                  t.parent().data("content", this.value),
                  t.remove();
              }),
            s.layBody
              .on(r.editTrigger, "td", function (e) {
                ...
                t.data("off") ||
                  (a &&
                    ...
                    ))[0].value = t.data("content") || i.text()),
                    t.find("." + D)[0] || t.append(a),
                    a.focus(),
                    layui.stope(e)));
              })
        ...
        s.layBody
          .on("click", "*[lay-event]", function () {
            return d.call(this), !1;
          })
          .on("dblclick", "*[lay-event]", function () {
            return d.call(this, "toolDouble"), !1;
          }),
  ...
  (b.eachCols = function (e, a, i) {
    ...
    (b.checkStatus = function (e) {
      ...
      return (
        layui.each(e, function (e, t) {
          "array" === layui.type(t)
            ? i++
            : t[b.config.checkName] &&
              (a++, t[b.config.disabledName] || l.push(b.clearCacheKey(t)));
        }),
    ...
    (b.getData = function (e) {
      ...
      return (
        layui.each(e, function (e, t) {
          "array" !== layui.type(t) && a.push(b.clearCacheKey(t));
        }),
        a
      );
    }),
    (b.exportFile = function (e, t, a) {
          ...
          layui.each(t, function (l, n) {
            ...
            "object" == typeof e
              ? (layui.each(e, function (e, t) {
                ...
                layui.each(b.clearCacheKey(n), function (e, t) {
                  o.push('"' + (t || "") + '"');
                }))
              : b.eachCols(e, function (e, t) {
                  ...
                  t.field &&
                    ...
                    (t.hide
                      ? 0 == l && (r[t.field] = !0)
                      : ((a = n[t.field]),
                        (i = c.layBody.find('tr[data-index="' + l + '"]>td')),
    ...
    (b.resize = function (e) {
      e
        ? l(e) && x.that[e].resize()
        : layui.each(x.that, function () {
            this.resize();
          });
    }),
    (b.reload = function (e, t, a, i) {
      if (l(e)) return (e = x.that[e]), e.reload(t, a, i), x.call(e);
    }),
    ...
    (b.clearCacheKey = function (e) {
      return (
        delete (e = m.extend({}, e))[b.config.checkName],
        delete e[b.config.indexName],
        delete e[b.config.disabledName],
        e
      );
    }),
    m(function () {
...
layui.define(["laytpl", "form"], function (e) {
  ...
  (v.prototype.config = {
    ...
    (v.prototype.render = function () {
      var e = this,
        t = e.config,
        a = (e.elem = d(n(p).render({ data: t, index: e.index }))),
        i = (t.elem = d(t.elem));
      i[0] &&
        ((t.data = t.data || []),
        (t.value = t.value || []),
